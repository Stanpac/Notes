...
// Chaque navigation SPA de Quartz
document.addEventListener("nav", () => {
    // Destroy les anciens carousels pour éviter les conflits
    document.querySelectorAll<HTMLElement>(".quartz-carousel").forEach((carousel) => {
